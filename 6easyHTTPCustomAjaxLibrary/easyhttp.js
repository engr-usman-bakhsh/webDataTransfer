...
// // this is going to be is=n ES% object oriented library ao we are using prototypes instead of classes.
...
easyHTTP.prototype.get = function(url,callBack){
  ...
  this.http.onload = function() { // it will work if function is removed and => is putt after parenthesis
    // we cannot use 'this' here, because its for a block level scope.App
    if(self.http.status === 200){
      //here this.http is undefined in this case
      // we can solve this problem by usin arrow function which is actually used in ES6, we'll learn it letter.
